...
#define GC2145_ID_MSB       0x21
#define GC2145_ID_LSB       0X45
#define GC2145_ID_MSB_REG   0xF0
#define GC2145_ID_LSB_REG   0xF1

static const unsigned char gc2145_reglist[][2] =
{
    {0xfe, 0xf0},
    {0xfe, 0xf0},
...
//1280x720
static const unsigned char gc2145_1280_720[][2] =
{
    {0xfe, 0x00},
    {0xf7, 0x1d},
    {0xf8, 0x83},
...
//640*480
static const unsigned char gc2145_640_480[][2] =
{
    {0xfe, 0x00},
    {0xf7, 0x1d},
    {0xf8, 0x83},
...
//320*240
static const unsigned char gc2145_320_240[][2] =
{
    {0xfe, 0x00},
    {0xf7, 0x1d},
    {0xf8, 0x83},
...
static const unsigned char gc2145_20fps[][2] =
{
    {0xfe, 0x00},
    {0xf7, 0x1d},
    {0xf8, 0x83},
...
static const unsigned char gc2145_15fps[][2] =
{
    {0xfe, 0x00},
    {0xf7, 0x1d},
    {0xf8, 0x83},
...
static const unsigned char gc2145_10fps[][2] =
{
    {0xfe, 0x00},
    {0xf7, 0x1d},
    {0xf8, 0x83},
...
//gragscale enable
static const unsigned char gc2145_gray_enable[][2] =
{
    {0xfe, 0x00},
    {0x83, 0x02},
    {0xfe, 0x02},
...
//gragscale disable
static const unsigned char gc2145_gray_disable[][2] =
{
    {0xfe, 0x00},
    {0x83, 0x00},
    {0xfe, 0x02},
...
#define SCCB_Read(addr, data)       camera_intf_sccb_read(addr, data)
#define SCCB_Write(addr, data)      camera_intf_sccb_write(addr, data)

int gc2145_probe(void)
{
    UINT8 id_msb = 0, id_lsb = 0;
    SCCB_Read(GC2145_ID_MSB_REG, &id_msb);
    SCCB_Read(GC2145_ID_LSB_REG, &id_lsb);
    CAMERA_INTF_PRT("gc2145 msb:%02x lsb:%02x\r\n", id_msb, id_lsb);

    if ((GC2145_ID_MSB == id_msb) && (GC2145_ID_LSB == id_lsb))
    {
        CAMERA_INTF_PRT("GC2145 ID matched\r\n");
        return 0;
    }
    else
    {
        CAMERA_INTF_PRT("GC2145 ID not matched\r\n");
        return -1;
    }
}
...
{
    int i;
    for (i = 0; i < sizeof(gc2145_reglist) / sizeof(gc2145_reglist[0]); i++)
    {
        SCCB_Write(gc2145_reglist[i][0], gc2145_reglist[i][1]);
    }
...
void gc2145_init(int mode)
{
    ...
    if (mode == 0)
    {
        for (i = 0; i < sizeof(gc2145_320_240) / sizeof(gc2145_320_240[0]); i++)
        {
            SCCB_Write(gc2145_320_240[i][0], gc2145_320_240[i][1]);
        }
    }
    else if (mode == 1)
    {
        for (i = 0; i < sizeof(gc2145_640_480) / sizeof(gc2145_640_480[0]); i++)
        {
            SCCB_Write(gc2145_640_480[i][0], gc2145_640_480[i][1]);
        }
    }
    else if (mode == 2)
    {
        for (i = 0; i < sizeof(gc2145_1280_720) / sizeof(gc2145_1280_720[0]); i++)
        {
            SCCB_Write(gc2145_1280_720[i][0], gc2145_1280_720[i][1]);
        }
    }
...
void gc2145_grayscale(int mode)
{
    ...
    if (mode)
    {
        for (i = 0; i < sizeof(gc2145_gray_enable) / sizeof(gc2145_gray_enable[0]); i++)
        {
            SCCB_Write(gc2145_gray_enable[i][0], gc2145_gray_enable[i][1]);
        }
    }
    else
    {
        for (i = 0; i < sizeof(gc2145_gray_disable) / sizeof(gc2145_gray_disable[0]); i++)
        {
            SCCB_Write(gc2145_gray_disable[i][0], gc2145_gray_disable[i][1]);
        }
    }
}

//void gc0308_dpi_reset(void)
//{
//    int i;
//    for (i = 0; i < sizeof(gc0308_dpi_rst)/sizeof(gc0308_dpi_rst[0]); i++)
//    {
//       SCCB_Write(gc0308_dpi_rst[i][0], (uint8_t*)&gc0308_dpi_rst[i][1]);
//    }
//}

unsigned char gc2145_fps(unsigned char fps)
{
    unsigned char ret_fps = 0;
    int i = 0;

    switch (fps)
    {
    case 12:
        for (i = 0; i < sizeof(gc2145_10fps) / sizeof(gc2145_10fps[0]); i++)
        {
            SCCB_Write(gc2145_10fps[i][0], gc2145_10fps[i][1]);
        }
        break;
    case 15:
        for (i = 0; i < sizeof(gc2145_15fps) / sizeof(gc2145_15fps[0]); i++)
        {
            SCCB_Write(gc2145_15fps[i][0], gc2145_15fps[i][1]);
        }
        break;
    case 20:
        for (i = 0; i < sizeof(gc2145_20fps) / sizeof(gc2145_20fps[0]); i++)
        {
            SCCB_Write(gc2145_20fps[i][0], gc2145_20fps[i][1]);
        }
        break;
    default:
        ret_fps = 15;
